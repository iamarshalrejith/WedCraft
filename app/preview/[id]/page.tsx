...
const LIGHT_BG = ["eternal-bloom","sacred-vows","paper-and-petals","rustic-bloom","zen-garden"];
...
const celestialDemo: CoupleDetails = { groomName:"Aryan", brideName:"Luna", weddingDate:"2027-01-20", weddingTime:"8:00 PM", venue:"Skyview Terrace", venueAddress:"Hilltop, Coorg, Karnataka", mapLink:"https://maps.google.com", phone:"+919876543210", personalMessage:"Two souls, aligned by the universe. The stars have led us to this moment — come celebrate with us.", events:[{name:"Stargazing Cocktails",date:"2027-01-20",time:"7:00 PM",venue:"Observatory Deck"},{name:"Celestial Ceremony",date:"2027-01-20",time:"8:00 PM",venue:"Skyview Terrace"},{name:"Midnight Celebration",date:"2027-01-20",time:"10:00 PM",venue:"Skyview Terrace"}] };
const rusticDemo: CoupleDetails = { groomName:"Aarav", brideName:"Kavya", weddingDate:"2026-10-25", weddingTime:"5:00 PM", venue:"The Farmhouse at Sunset", venueAddress:"Old Bangalore Road, Mysore", mapLink:"https://maps.google.com", phone:"+919876543210", personalMessage:"Beneath the open sky and surrounded by wildflowers, two hearts become one.", events:[{name:"Phoolon Ki Holi",date:"2026-10-24",time:"4:00 PM",venue:"The Garden"},{name:"Wedding Ceremony",date:"2026-10-25",time:"5:00 PM",venue:"The Farmhouse Lawn"},{name:"Bonfire Reception",date:"2026-10-25",time:"8:00 PM",venue:"The Farmhouse"}] };
const zenDemo: CoupleDetails = { groomName:"Kenji", brideName:"Sakura", weddingDate:"2026-08-08", weddingTime:"3:00 PM", venue:"The Japanese Garden", venueAddress:"Lalbagh Botanical Garden, Bangalore", mapLink:"https://maps.google.com", phone:"+919876543210", personalMessage:"In the stillness of this moment, two paths become one.", events:[{name:"Tea Ceremony",date:"2026-08-08",time:"2:00 PM",venue:"The Pavilion"},{name:"Wedding Ceremony",date:"2026-08-08",time:"3:00 PM",venue:"The Japanese Garden"},{name:"Dinner Reception",date:"2026-08-08",time:"7:00 PM",venue:"The Garden Hall"}] };
const midnightDemo: CoupleDetails = { groomName:"Sebastian", brideName:"Rosalind", weddingDate:"2027-02-07", weddingTime:"7:00 PM", venue:"The Rose Manor", venueAddress:"Coonoor, Nilgiris, Tamil Nadu", mapLink:"https://maps.google.com", phone:"+919876543210", personalMessage:"Like a rose that blooms in the darkest night, our love found each other.", events:[{name:"Cocktail Evening",date:"2027-02-07",time:"6:00 PM",venue:"The Rose Garden"},{name:"Wedding Ceremony",date:"2027-02-07",time:"7:00 PM",venue:"The Grand Manor"},{name:"Midnight Ball",date:"2027-02-07",time:"9:00 PM",venue:"The Grand Ballroom"}] };
    ...
    <div className="relative">
      ...
      <motion.div initial={{y:100,opacity:0}} animate={{y:0,opacity:1}} transition={{delay:0.6,type:"spring",stiffness:200}}
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 flex items-center gap-4">
          ...
          <Link href={`/checkout/${template.slug}`} className="flex items-center gap-2 bg-black text-white px-5 py-3 rounded-xl font-semibold text-sm hover:bg-gray-800 active:scale-95 transition-all shrink-0">
