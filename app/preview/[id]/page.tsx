    ...
    {Array.from({ length: 14 }).map((_, row) =>
      Array.from({ length: 10 }).map((_, col) => (
        <div key={`${row}-${col}`} className="absolute"
          ...
          <span style={{ display:"block", fontSize:22, fontWeight:700, letterSpacing:"0.2em", whiteSpace:"nowrap", color:"#000000", opacity: lightBg ? 0.12 : 0.06 }}>
            WEDCRAFT PREVIEW
          </span>
          {/* Light layer — visible on dark backgrounds */}
          <span style={{ display:"block", fontSize:22, fontWeight:700, letterSpacing:"0.2em", whiteSpace:"nowrap", color:"#ffffff", opacity: lightBg ? 0.05 : 0.12, marginTop:-26 }}>
            WEDCRAFT PREVIEW
          </span>
        </div>
      ))
...
// Demo couple data per template style
const hinduDemo: CoupleDetails = {
  groomName:"Aravind", brideName:"Aarathi", weddingDate:"2026-12-12", weddingTime:"7:00 PM",
...
const modernDemo: CoupleDetails = {
  groomName:"Arjun", brideName:"Meera", weddingDate:"2026-11-20", weddingTime:"5:30 PM",
...
const beachDemo: CoupleDetails = {
  groomName:"Kiran", brideName:"Nadia", weddingDate:"2027-01-15", weddingTime:"4:00 PM",
...
const nikahDemo: CoupleDetails = {
  groomName:"Zaid", brideName:"Ayesha", weddingDate:"2026-10-10", weddingTime:"11:00 AM",
  venue:"Al Noor Convention Hall", venueAddress:"Banjara Hills, Hyderabad",
  mapLink:"https://maps.google.com", phone:"+919876543210",
  personalMessage:"And of His signs is that He created for you mates that you may find tranquillity in them.",
  events:[
    { name:"Nikah Ceremony", date:"2026-10-10", time:"11:00 AM", venue:"Al Noor Convention Hall" },
    { name:"Walima Reception", date:"2026-10-11", time:"7:00 PM", venue:"Al Noor Banquet" },
  ],
};

const luxuryDemo: CoupleDetails = {
  groomName:"Rohan", brideName:"Ananya", weddingDate:"2027-02-14", weddingTime:"7:30 PM",
  venue:"The Leela Palace", venueAddress:"MG Road, Bengaluru",
  mapLink:"https://maps.google.com", phone:"+919876543210",
  personalMessage:"To love and be loved is everything. We invite you to witness the most beautiful chapter of our story.",
  events:[
    { name:"Cocktail Reception", date:"2027-02-14", time:"6:00 PM", venue:"The Leela Terrace" },
    { name:"Wedding Ceremony", date:"2027-02-14", time:"7:30 PM", venue:"The Grand Ballroom" },
    { name:"Dinner & Dancing", date:"2027-02-14", time:"9:30 PM", venue:"The Grand Ballroom" },
  ],
};

function getPreview(slug: string) {
  if (slug === "mangal-utsav" || slug === "anand-karaj") return <MangalUtsav couple={hinduDemo}/>;
  if (slug === "eternal-bloom" || slug === "sacred-vows" || slug === "paper-and-petals") return <EternalBloom couple={modernDemo}/>;
  if (slug === "azure-shore") return <AzureShore couple={beachDemo}/>;
  if (slug === "nikah-nazm") return <NikahNazm couple={nikahDemo}/>;
  if (slug === "onyx-and-gold") return <OnyxGold couple={luxuryDemo}/>;
...
export default function PreviewPage({ params }: PreviewPageProps) {
  ...
  return (
    <div className="relative">
      ...
      <WatermarkOverlay lightBg={["eternal-bloom","sacred-vows","paper-and-petals"].includes(id)}/>
