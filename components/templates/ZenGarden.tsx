...
function FamilySection({ couple }: { couple: CoupleDetails }) {
  ...
  const ParentsCard = ({ sideLabel, fatherName, motherName, delay }: { sideLabel: string; fatherName?: string; motherName?: string; delay: number }) => (
    <Reveal delay={delay}>
      <div style={{ background:"rgba(255,255,255,0.08)", border:"1px solid rgba(255,255,255,0.18)", borderRadius:8, padding:"22px 16px", textAlign:"center", height:"100%" }}>
        ...
        {fatherName && (<div style={{ marginBottom: motherName ? 12 : 0 }}>
          <p style={{ fontFamily:"'Noto Serif JP',serif", fontSize:16, color:"rgba(255,255,255,0.9)", lineHeight:1.3 }}>{fatherName}</p>
        ...
        {fatherName && motherName && <div style={{ height:"0.5px", background:"rgba(255,255,255,0.18)", margin:"10px auto", width:36 }} />}
        {motherName && (<div>
          <p style={{ fontFamily:"'Noto Serif JP',serif", fontSize:16, color:"rgba(255,255,255,0.9)", lineHeight:1.3 }}>{motherName}</p>
  ...
  const RelativeCard = ({ rel, delay }: { rel: { name: string; relation: string; spouseName?: string }; delay: number }) => (
    <Reveal delay={delay}>
      <div style={{ background:"rgba(255,255,255,0.08)", border:"1px solid rgba(255,255,255,0.18)", borderRadius:6, padding:"11px", textAlign:"center", borderLeft:"2px solid rgba(255,255,255,0.18)" }}>
        ...
        <p style={{ fontFamily:"'Noto Serif JP',serif", fontSize:14, color:"rgba(255,255,255,0.9)", lineHeight:1.3 }}>{rel.name}</p>
        {rel.spouseName && (<>
          <div style={{ display:"flex", alignItems:"center", gap:5, justifyContent:"center", margin:"4px 0" }}>
            <div style={{ height:"0.5px", flex:1, background:"rgba(255,255,255,0.18)" }} />
            <span style={{ fontSize:9, color:"rgba(255,255,255,0.45)" }}>&amp;</span>
            <div style={{ height:"0.5px", flex:1, background:"rgba(255,255,255,0.18)" }} />
          </div>
          <p style={{ fontFamily:"'Noto Serif JP',serif", fontSize:13, color:"rgba(255,255,255,0.9)", lineHeight:1.3, opacity:0.7 }}>{rel.spouseName}</p>
        </>)}
      </div>
    </Reveal>
  );
    ...
    <section style={{ padding:"20px 20px 52px", maxWidth:580, margin:"0 auto" }}>
      <Reveal>
        <div style={{ textAlign:"center", marginBottom:26 }}>
          ...
          <p style={{ fontFamily:"'Noto Serif JP',serif", fontSize:22, color:"rgba(255,255,255,0.9)" }}>Our Families</p>
        </div>
      </Reveal>
      {hasParents && (
        ...
        <>
          <Reveal delay={0.25}>
            <div style={{ display:"flex", alignItems:"center", gap:10, margin:"4px 0 18px" }}>
              <div style={{ flex:1, height:"0.5px", background:"rgba(255,255,255,0.18)" }} />
